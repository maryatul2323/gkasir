...
const Datameja = ({ navigation }) => {
  ...
  return (
    <ImageBackground source={Background} style={styles.background}>
      ...
      <Text style={styles.meja}> No Meja </Text>
      <View style={styles.NoMeja}>
        <DropDownPicker
          open={open}
          value={value}
          items={datameja}
          setOpen={setOpen}
          setValue={setValue}
          setItems={setdatameja}
          style={{ borderColor: 'white', color: 'black' }}
          placeholder='pilih no meja'
        />
        {/* <RNPickerSelect
